...
begin
  ...
  if frDataModule.tbCadastro.FindKey([edCodigo.Text]) then   //Caso exista o código,
    begin
     frDataModule.tbCadastro.Delete;                         //Deleta as informações desse cadastro na tabela
     pMensagemLimpaCampos(True, True, 'Cadastro excluído');  //Procedure pra limpar campos e exibir mensagem de exclusão com sucesso
    end;
end;
