...
begin
  ...
  if cbPrioridade.ItemIndex = 0 then
     ...
     wPrioridade:= 'Emergência';

  wTexto:= ('Nome: ' + edNome.Text + ' Código: ' + edCodigo.Text + ' Sexo: ' + wSexo + ' Prioridade: ' + wPrioridade);
  wStringList.Add('Nome: ' + edNome.Text + ' Código: ' + edCodigo.Text + ' Sexo: ' + wSexo + ' Prioridade: ' + wPrioridade);
